...
public class CardLoader {
	...
	/*
	 * public static LinkedList<Card> randomDeck(){ LinkedList<Card> deck=new
	 * LinkedList<>(); for(int i=0;i<Battle.deckSize;i++) { Card
	 * card=Game.ins.playerCards.get(Rnd.nextInt(Game.ins.playerCards.size()));
	 * deck.add(card); } return deck; }
	 */
